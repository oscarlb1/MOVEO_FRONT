      ...
      <Teleport to="body">
        <Transition name="fade-menu">
          <div 
            ...
            class="fixed inset-0 z-[100] bg-[#1A1D23] flex flex-col"
          >
            <!-- Cabecera del menú móvil (fija arriba) -->
            <div class="flex items-center justify-between p-6 border-b border-white/5">
              <div class="flex items-center gap-3">
                <div class="w-10 h-10 bg-[#E67E50] rounded-xl flex items-center justify-center shadow-lg shadow-[#E67E50]/20">
            ...
            <div class="flex-1 overflow-y-auto px-6 py-8">
              <div class="flex flex-col gap-4">
                <router-link
                  ...
                  :to="enlace.to"
                  @click="menuMovilAbierto = false"
                  class="px-5 py-4 text-xl rounded-2xl font-medium transition-colors"
                  :class="paginaActiva === enlace.activeKey 
                ...
                <template v-if="!estaAutenticado">
                  <button 
                    @click="router.push({ name: 'login' }); menuMovilAbierto = false"
                ...
                <template v-else>
                  ...
                  <div class="bg-white/5 rounded-2xl p-4 mb-4 flex items-center gap-4">
                     <div class="w-12 h-12 bg-[#E67E50] rounded-full flex items-center justify-center text-white font-bold text-lg overflow-hidden shrink-0">
                       <img v-if="usuario?.imagenUrl" :src="usuario.imagenUrl" alt="Foto" class="w-full h-full object-cover" />
                       <span v-else>{{ usuario?.nombre?.substring(0, 2).toUpperCase() }}</span>
                     </div>
                     <div class="min-w-0">
                  ...
                  <button 
                    @click="irAConfiguracion(); menuMovilAbierto = false"
