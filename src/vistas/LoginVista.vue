<template>
  <div
    class="min-h-screen bg-gradient-to-br from-[#092C4C] via-[#374B54] to-[#092C4C] flex items-center justify-center relative">
    ...
    <div class="w-full max-w-7xl flex min-h-screen">
      <div class="w-full lg:w-1/2 flex items-start justify-center p-4 sm:p-6 lg:p-12 pt-20 sm:pt-24">
        <div v-motion :initial="{ opacity: 0, x: -30 }" :enter="{ opacity: 1, x: 0, transition: { duration: 600 } }"
          class="w-[95%] sm:w-full max-w-md mx-auto">
          <div v-motion :initial="{ opacity: 0, y: -20 }" :enter="{ opacity: 1, y: 0, transition: { delay: 200 } }"
            class="mb-8">
            <div class="inline-flex items-center gap-2 mb-4 cursor-pointer hover:opacity-80 transition-opacity"
              @click="navigate('home')">
              <div
                class="w-10 h-10 bg-[#E67E50] rounded-lg flex items-center justify-center shadow-lg shadow-[#E67E50]/20">
            ...
            <form @submit.prevent="handleLogin" class="space-y-6">
              <div>
                ...
                <div class="relative">
                  ...
                  <input id="email" type="email" v-model="email" placeholder="tu@empresa.com" required :class="[
              ...
              <div class="flex items-center justify-between">
                ...
                <button type="button" class="text-[#E67E50] text-sm font-medium hover:text-[#d66d40] transition-colors">
              ...
              <div class="mt-10 pt-8 border-t border-white/10">
                <div
                  class="bg-white/5 rounded-2xl p-6 border border-white/5 hover:border-white/10 transition-all group/card">
                  <div class="flex items-center gap-4 mb-4">
                    <div
                      class="w-10 h-10 bg-[#E67E50]/20 rounded-xl flex items-center justify-center text-[#E67E50] group-hover/card:scale-110 transition-transform">
                  ...
                  <button type="button" @click="router.push('/contacto?sinHeader=true')"
      ...
      <div v-motion :initial="{ opacity: 0, x: 30 }"
        ...
        <div class="absolute inset-0 overflow-hidden opacity-20">
          <svg class="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
            ...
            <path class="ruta-animada ruta-1" d="M 100 200 Q 300 100 500 300 T 900 200" stroke="#E67E50"
              stroke-width="2" fill="none" />
            <path class="ruta-animada ruta-2" d="M 50 400 Q 400 300 700 500" stroke="#374B54" stroke-width="2"
              fill="none" />
          </svg>
        ...
        <div class="relative z-10 max-w-lg">
          ...
          <div class="space-y-6">
            <div v-for="(feature, index) in features" :key="index" v-motion :initial="{ opacity: 0, x: 20 }"
          ...
          <div v-motion :initial="{ opacity: 0, y: 20 }" :enter="{ opacity: 1, y: 0, transition: { delay: 900 } }"
