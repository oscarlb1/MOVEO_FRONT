...
const chartOptionsArea = computed<ApexOptions>(() => ({
  ...
  xaxis: {
    ...
    labels: { style: { colors: props.darkMode ? '#82A1B1' : '#757575' } }
  },
  yaxis: { labels: { style: { colors: props.darkMode ? '#82A1B1' : '#757575' } } },
  grid: { borderColor: props.darkMode ? '#374B54' : '#EEEEEE', strokeDashArray: 4 },
  ...
  plotOptions: {
    pie: {
      donut: {
        ...
        labels: {
          show: true,
          name: { color: props.darkMode ? '#82A1B1' : '#757575' }, // Arreglo para que Mantenimiento sea legible
          value: { color: props.darkMode ? '#ffffff' : '#424242', fontWeight: '700', fontSize: '20px' },
          total: { show: true, label: 'Total', color: props.darkMode ? '#82A1B1' : '#757575' },
        }
      }
    }
  },
      ...
      if (ubicacion) {
        ...
        if (marcadoresVehiculos.has(ruta.id)) {
          ...
          const icon = L.divIcon({
            ...
            html: `<div class="w-4 h-4 rounded-full shadow-lg border-2 ${props.darkMode ? 'border-[#272A30]' : 'border-white'}" style="background-color: #E67E50;">
        ...
        <div class="flex items-center justify-between mb-4">
          <div>
            ...
            <div class="flex items-center gap-2 text-sm">
              ...
              <span class="text-[#757575] dark:text-[#82A1B1]">{{ rutasActivas.length }} rutas activas</span>
            </div>
          </div>
        </div>
    ...
    <div class="rounded-2xl border shadow-sm p-6 bg-white dark:bg-[#272A30] border-gray-100 dark:border-[#374B54]">
      ...
      <div v-else>
        ...
        <div v-else class="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
          <div v-for="u in repartidoresActivos" :key="u.usuarioId" class="flex items-center gap-3 p-4 rounded-xl border transition-all" :class="[darkMode ? 'border-gray-700 bg-[#16181A]/50' : 'border-gray-100 bg-gray-50', u.estaActivo ? '' : 'opacity-50']">
            <div class="relative flex-shrink-0">
              ...
              <span class="absolute -bottom-0.5 -right-0.5 w-3 h-3 rounded-full border-2" :class="[u.estaActivo ? 'bg-green-500' : 'bg-gray-400', darkMode ? 'border-[#16181A]' : 'border-gray-50']"></span>
            </div>
